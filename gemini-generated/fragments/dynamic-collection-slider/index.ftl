<div
  class="dynamic-slider-container slider-${fragmentEntryLinkNamespace}"
  style="
    --theme-color: ${configuration.themeColor!};
    --slide-gap: ${configuration.spacing!};
  ...
  aria-label="Collection Content Slider"
>
  <div
  ...
  <div class="slider-viewport">
    <div
      class="slider-track"
      id="track-${fragmentEntryLinkNamespace}"
      aria-live="polite"
    >
      <!-- Slides dynamically injected here -->
      <div class="slider-status">Loading collection items...</div>
    </div>
  </div>
