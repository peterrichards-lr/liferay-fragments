  ...
  <div class="align-items-start bg-transparent container-fluid mr-5">
    <div class="col">
      <div class="navbar navbar-expand-xl">
        <button
          aria-controls="lowerNavigation"
          aria-expanded="false"
          aria-label="Toggle navigation"
          class="navbar-toggler"
          data-target="#lowerNavigation"
          data-toggle="collapse"
          type="button"
        >
          <svg class="lexicon-icon">
            <use
              xlink:href="${themeDisplay.getPathThemeImages()}/clay/icons.svg#bars"
            ></use>
          </svg>
        </button>

        <div class="collapse mt-4 navbar-collapse" id="lowerNavigation">
          <div role="search">
    ...
    <div class="autofit-col">[@liferay_commerce_ui["account-selector"] /]</div>
