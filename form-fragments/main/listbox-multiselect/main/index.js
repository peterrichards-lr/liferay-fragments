const initListboxMultiselect = () => {
  const availableOptions = fragmentElement.querySelector(
    '.list-available-options'
  );
  const selectedOptions = fragmentElement.querySelector(
  ...
  // Initially ensure selected items are marked selected
