const inputEl = fragmentElement.querySelector(
  `#${fragmentNamespace}-text-input`
);
const inputConfirmationEl = fragmentElement.querySelector(
  `#${fragmentNamespace}-text-confirmation-input`
);
  ...
  if (layoutMode === 'edit') {
    ...
    if (feedbackGroup) {
      const clearError = (e) => {
        ...
        else feedbackGroup.style.display = 'none';
      };
