<div
  ...
  style="
    ...
    --icon-color: ${configuration.iconColor};
...
>
  ...
  ></span>
  <div
    class="service-card___content d-none flex-row align-items-center justify-content-start"
  >
    ...
    <div class="d-flex flex-column flex-grow-1">
      <div
        class="component-heading h5 mb-0 text-break"
      ...
      <div
        class="clearfix component-paragraph text-paragraph-sm text-break"
        data-lfr-editable-id="service-description"
        data-lfr-editable-type="rich-text"
      >
        Description
      </div>
    </div>
    <div>[@clay["icon"] symbol="angle-right" /]</div>
  </div>
