<div class="service-link-button">
  ...
  ></span>
  <div class="service-link-button___content d-none">
    <div class="component-button text-break">
      <a
        class="btn btn-${configuration.buttonSize!} btn-${configuration.buttonType!}"
        href=""
        id="fragment-${fragmentEntryLinkNamespace}-service-link"
      >
        [#if themeDisplay.isSignedIn()] Go to Service [#else] Login for Service
        [/#if]
      </a>
    </div>
  </div>
