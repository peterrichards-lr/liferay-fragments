...
A visualization grid showing data density (e.g., check-ins, readings) over time
from Liferay Object data.
...
- **Runtime Size Selector**: Optional dropdown to allow users to switch between
...
- **Show Size Selector**: Enable a dropdown at runtime to change the display
  range.
