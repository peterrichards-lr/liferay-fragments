...
![Interactive Event Timeline - Milestone View](../images/interactive-event-timeline.png)

![Interactive Event Timeline - Configuration](../images/interactive-event-timeline-config.png)
