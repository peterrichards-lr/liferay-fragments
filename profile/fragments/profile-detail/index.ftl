...
<div class="profile-detail">
  ...
  <div class="row">
    ...
    <div class="cell">
      ${profileUser.getExpandoBridge().getAttribute("Availability")?string('dd
      MMM yyyy')}
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="cell">
      ${profileUser.getExpandoBridge().getAttribute("Current
      Rate")?string('£#,##0.00')}
    </div>
    <div class="cell">Expected Rate</div>
    <div class="cell">
      ${profileUser.getExpandoBridge().getAttribute("Expected
      Rate")?string('£#,##0.00')}
    </div>
  </div>
  <div class="row">
