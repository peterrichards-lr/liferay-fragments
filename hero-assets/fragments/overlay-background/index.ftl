[#function _hexDigit c] [#-- prettier-ignore --] [#assign c = c?lower_case]
[#return
...
h?substring(2,3) + h?substring(2,3)] [/#if] [#if h?length != 6] [#return
"rgba(0,0,0," + (a) + ")"] [/#if] [#assign r = _hexPairToInt(h?substring(0,2))]
