const initResponsiveMenu = () => {
  setTimeout(() => {
    ...
    if (root && layoutMode === "view") {
      ...
      const menuImageSelector =
        ".dropzone-menu.fragment-menu .text-truncate img";
      const isRtl =
      ...
      const menuHasImages = () =>
        !!fragmentMenu?.querySelector(menuImageSelector);
      ...
      const syncLogoMode = (options = {}) => {
        ...
        const open =
          typeof forcedOpen === "boolean" ? forcedOpen : isMenuOpenInternal();
      ...
      const onToggle = () =>
        isMenuOpenInternal() ? closeMenu(true) : openMenu();
